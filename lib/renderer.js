  ...
  serialize: function serialize(obj, children, document) {
    ...
    switch (obj.type) {
      ...
      case "image":
        ...
        return "![" + alt + "](" + src + ")\n";
      case "linkbar":
        var img = (0, _urls.encode)(obj.getIn(["data", "image"]) || "");
        var url = (0, _urls.encode)(obj.getIn(["data", "url"]) || "");
        var title = obj.getIn(["data", "title"]);
        var desc = obj.getIn(["data", "description"]);
        var domain = obj.getIn(["data", "domain"]);
  ...
  serialize: function serialize(obj, children) {
    ...
    switch (obj.type) {
      ...
      case "code-line":
        return "`" + children + "`";
      case "mention":
        var username = obj.getIn(["data", "username"]) || "";
        var anon = obj.getIn(["data", "anonymous"]) || "";
